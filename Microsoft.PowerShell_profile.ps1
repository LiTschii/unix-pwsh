$githubUser = "LiTschii" # Change this here if you forked the repository.
$name= "liu" # Change this to your name.
...
$OhMyPoshConfigFileName = "my-theme.json" # Filename of the OhMyPosh config file
